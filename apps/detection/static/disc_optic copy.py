...
# Función para visualizar la imagen original y la imagen segmentada
def show_segmentation(original_image_path, predicted_mask):
    # Carga la imagen original
    original_image = cv2.imread(original_image_path)
    original_image = cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB)

    # Asegúrate de que la máscara tenga la forma correcta
    ...
    # Mostrar la imagen original y la imagen con la máscara de segmentación
